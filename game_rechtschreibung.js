...
var RS = (function() {
  ...
  var WORDS = {
    tz_z: [
      {correct:'Katze',wrong:'Kaze',type:'tz',rule:'Nach kurzem a steht tz.'},
      {correct:'Tatze',wrong:'Taze',type:'tz',rule:'Nach kurzem a steht tz.'},
      {correct:'Matratze',wrong:'Matraze',type:'tz',rule:'Nach kurzem a steht tz.'},
      {correct:'Glatze',wrong:'Glaze',type:'tz',rule:'Nach kurzem a steht tz.'},
      {correct:'Platz',wrong:'Plaz',type:'tz',rule:'Nach kurzem a steht tz.'},
      {correct:'Satz',wrong:'Saz',type:'tz',rule:'Nach kurzem a steht tz.'},
      {correct:'Schatz',wrong:'Schaz',type:'tz',rule:'Nach kurzem a steht tz.'},
      {correct:'Spatz',wrong:'Spaz',type:'tz',rule:'Nach kurzem a steht tz.'},
      {correct:'kratzen',wrong:'krazen',type:'tz',rule:'Nach kurzem a steht tz.'},
      {correct:'platzen',wrong:'plazen',type:'tz',rule:'Nach kurzem a steht tz.'},
      {correct:'setzen',wrong:'sezen',type:'tz',rule:'Nach kurzem e steht tz.'},
      {correct:'hetzen',wrong:'hezen',type:'tz',rule:'Nach kurzem e steht tz.'},
      {correct:'Netz',wrong:'Nez',type:'tz',rule:'Nach kurzem e steht tz.'},
      {correct:'Fetzen',wrong:'Fezen',type:'tz',rule:'Nach kurzem e steht tz.'},
      {correct:'verletzen',wrong:'verlezen',type:'tz',rule:'Nach kurzem e steht tz.'},
      {correct:'sitzen',wrong:'sizen',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'Witz',wrong:'Wiz',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'Blitz',wrong:'Bliz',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'Hitze',wrong:'Hize',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'Spitze',wrong:'Spize',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'Pfütze',wrong:'Pfüze',type:'tz',rule:'Nach kurzem ü steht tz.'},
      {correct:'Mütze',wrong:'Müze',type:'tz',rule:'Nach kurzem ü steht tz.'},
      {correct:'schützen',wrong:'schüzen',type:'tz',rule:'Nach kurzem ü steht tz.'},
      {correct:'stützen',wrong:'stüzen',type:'tz',rule:'Nach kurzem ü steht tz.'},
      {correct:'nützen',wrong:'nüzen',type:'tz',rule:'Nach kurzem ü steht tz.'},
      {correct:'putzen',wrong:'puzen',type:'tz',rule:'Nach kurzem u steht tz.'},
      {correct:'Schmutz',wrong:'Schmuz',type:'tz',rule:'Nach kurzem u steht tz.'},
      {correct:'Schutz',wrong:'Schuz',type:'tz',rule:'Nach kurzem u steht tz.'},
      {correct:'Klotz',wrong:'Kloz',type:'tz',rule:'Nach kurzem o steht tz.'},
      {correct:'motzen',wrong:'mozen',type:'tz',rule:'Nach kurzem o steht tz.'},
      {correct:'trotzen',wrong:'trozen',type:'tz',rule:'Nach kurzem o steht tz.'},
      {correct:'plötzlich',wrong:'plözlich',type:'tz',rule:'Nach kurzem ö steht tz.'},
      {correct:'jetzt',wrong:'jezt',type:'tz',rule:'Nach kurzem e steht tz.'},
      {correct:'schwitzen',wrong:'schwizen',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'spritzen',wrong:'sprizen',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'flitzen',wrong:'flizen',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'besitzen',wrong:'besizen',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'erhitzen',wrong:'erhizen',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'Glitzer',wrong:'Glizer',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'kitzeln',wrong:'kizeln',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'Kritzel',wrong:'Krizel',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'Schnitzel',wrong:'Schnizel',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'schmutzig',wrong:'schmuzig',type:'tz',rule:'Nach kurzem u steht tz.'},
      {correct:'witzig',wrong:'wizig',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'nützlich',wrong:'nüzlich',type:'tz',rule:'Nach kurzem ü steht tz.'},
      {correct:'spitz',wrong:'spiz',type:'tz',rule:'Nach kurzem i steht tz.'},
      {correct:'Reiz',wrong:'Reitz',type:'z',rule:'Nach dem Doppellaut ei steht nur z.'},
      {correct:'reizen',wrong:'reitzen',type:'z',rule:'Nach dem Doppellaut ei steht nur z.'},
      {correct:'Weizen',wrong:'Weitzen',type:'z',rule:'Nach dem Doppellaut ei steht nur z.'},
      {correct:'kreuzen',wrong:'kreutzen',type:'z',rule:'Nach dem Doppellaut eu steht nur z.'},
      {correct:'geizen',wrong:'geitzen',type:'z',rule:'Nach dem Doppellaut ei steht nur z.'},
      {correct:'Heizung',wrong:'Heitzung',type:'z',rule:'Nach dem Doppellaut ei steht nur z.'},
      ...
      {correct:'Scherze',wrong:'Schertze',type:'z',rule:'Nach dem Mitlaut r steht nur z.'},
      ...
      {correct:'tanzen',wrong:'tantzen',type:'z',rule:'Nach dem Mitlaut n steht nur z.'},
      {correct:'ganz',wrong:'gantz',type:'z',rule:'Nach dem Mitlaut n steht nur z.'},
      ...
      {correct:'stolz',wrong:'stoltz',type:'z',rule:'Nach dem Mitlaut l steht nur z.'},
      ...
      {correct:'Pelz',wrong:'Peltz',type:'z',rule:'Nach dem Mitlaut l steht nur z.'},
    ...
    ck_k: [
      {correct:'Jacke',wrong:'Jake',type:'ck',rule:'Nach kurzem a steht ck.'},
      {correct:'backen',wrong:'baken',type:'ck',rule:'Nach kurzem a steht ck.'},
      {correct:'packen',wrong:'paken',type:'ck',rule:'Nach kurzem a steht ck.'},
      {correct:'Sack',wrong:'Sak',type:'ck',rule:'Nach kurzem a steht ck.'},
      {correct:'Nacken',wrong:'Naken',type:'ck',rule:'Nach kurzem a steht ck.'},
      {correct:'hacken',wrong:'haken',type:'ck',rule:'Nach kurzem a steht ck.'},
      {correct:'Lack',wrong:'Lak',type:'ck',rule:'Nach kurzem a steht ck.'},
      {correct:'knacken',wrong:'knaken',type:'ck',rule:'Nach kurzem a steht ck.'},
      {correct:'Bäcker',wrong:'Bäker',type:'ck',rule:'Nach kurzem ä steht ck.'},
      {correct:'lecker',wrong:'leker',type:'ck',rule:'Nach kurzem e steht ck.'},
      {correct:'Decke',wrong:'Deke',type:'ck',rule:'Nach kurzem e steht ck.'},
      {correct:'Ecke',wrong:'Eke',type:'ck',rule:'Nach kurzem e steht ck.'},
      {correct:'Fleck',wrong:'Flek',type:'ck',rule:'Nach kurzem e steht ck.'},
      {correct:'stecken',wrong:'steken',type:'ck',rule:'Nach kurzem e steht ck.'},
      {correct:'wecken',wrong:'weken',type:'ck',rule:'Nach kurzem e steht ck.'},
      {correct:'Becken',wrong:'Beken',type:'ck',rule:'Nach kurzem e steht ck.'},
      {correct:'Schnecke',wrong:'Schneke',type:'ck',rule:'Nach kurzem e steht ck.'},
      {correct:'Dreck',wrong:'Drek',type:'ck',rule:'Nach kurzem e steht ck.'},
      {correct:'Zweck',wrong:'Zwek',type:'ck',rule:'Nach kurzem e steht ck.'},
      {correct:'dick',wrong:'dik',type:'ck',rule:'Nach kurzem i steht ck.'},
      {correct:'Blick',wrong:'Blik',type:'ck',rule:'Nach kurzem i steht ck.'},
      {correct:'schicken',wrong:'schiken',type:'ck',rule:'Nach kurzem i steht ck.'},
      {correct:'Strick',wrong:'Strik',type:'ck',rule:'Nach kurzem i steht ck.'},
      {correct:'Stück',wrong:'Stük',type:'ck',rule:'Nach kurzem ü steht ck.'},
      {correct:'Glück',wrong:'Glük',type:'ck',rule:'Nach kurzem ü steht ck.'},
      {correct:'drücken',wrong:'drüken',type:'ck',rule:'Nach kurzem ü steht ck.'},
      {correct:'Rücken',wrong:'Rüken',type:'ck',rule:'Nach kurzem ü steht ck.'},
      {correct:'Brücke',wrong:'Brüke',type:'ck',rule:'Nach kurzem ü steht ck.'},
      {correct:'Lücke',wrong:'Lüke',type:'ck',rule:'Nach kurzem ü steht ck.'},
      {correct:'Mücke',wrong:'Müke',type:'ck',rule:'Nach kurzem ü steht ck.'},
      {correct:'pflücken',wrong:'pflüken',type:'ck',rule:'Nach kurzem ü steht ck.'},
      {correct:'schlucken',wrong:'schluken',type:'ck',rule:'Nach kurzem u steht ck.'},
      {correct:'Zucker',wrong:'Zuker',type:'ck',rule:'Nach kurzem u steht ck.'},
      {correct:'locker',wrong:'loker',type:'ck',rule:'Nach kurzem o steht ck.'},
      {correct:'Rock',wrong:'Rok',type:'ck',rule:'Nach kurzem o steht ck.'},
      {correct:'Stock',wrong:'Stok',type:'ck',rule:'Nach kurzem o steht ck.'},
      {correct:'Block',wrong:'Blok',type:'ck',rule:'Nach kurzem o steht ck.'},
      {correct:'trocken',wrong:'troken',type:'ck',rule:'Nach kurzem o steht ck.'},
      {correct:'Glocke',wrong:'Gloke',type:'ck',rule:'Nach kurzem o steht ck.'},
      {correct:'Schock',wrong:'Schok',type:'ck',rule:'Nach kurzem o steht ck.'},
      {correct:'hocken',wrong:'hoken',type:'ck',rule:'Nach kurzem o steht ck.'},
      {correct:'locken',wrong:'loken',type:'ck',rule:'Nach kurzem o steht ck.'},
      {correct:'Socke',wrong:'Soke',type:'ck',rule:'Nach kurzem o steht ck.'},
      {correct:'Acker',wrong:'Aker',type:'ck',rule:'Nach kurzem a steht ck.'},
      {correct:'meckern',wrong:'mekern',type:'ck',rule:'Nach kurzem e steht ck.'},
      {correct:'verstecken',wrong:'versteken',type:'ck',rule:'Nach kurzem e steht ck.'},
      ...
      {correct:'Ekel',wrong:'Eckel',type:'k',rule:'Nach dem langen e steht nur k.'},
      ...
      {correct:'wirken',wrong:'wircken',type:'k',rule:'Nach dem Mitlaut r steht nur k.'},
      ...
      {correct:'Markt',wrong:'Marckt',type:'k',rule:'Nach dem Mitlaut r steht nur k.'},
      {correct:'Werk',wrong:'Werck',type:'k',rule:'Nach dem Mitlaut r steht nur k.'},
      {correct:'Volk',wrong:'Volck',type:'k',rule:'Nach dem Mitlaut l steht nur k.'},
      ...
      {correct:'links',wrong:'lincks',type:'k',rule:'Nach dem Mitlaut n steht nur k.'},
      {correct:'winken',wrong:'wincken',type:'k',rule:'Nach dem Mitlaut n steht nur k.'},
      {correct:'Blinker',wrong:'Blincker',type:'k',rule:'Nach dem Mitlaut n steht nur k.'},
      {correct:'Geschenk',wrong:'Geschenck',type:'k',rule:'Nach dem Mitlaut n steht nur k.'}
    ]
  };
